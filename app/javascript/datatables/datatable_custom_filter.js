DT = (function () {
  ...
  var clear_button_todojf = function () {
    // Need to put this in the base framework
    setTimeout(function () {
      $($(".dataTables_filter label")[0]).append(
        "<div class='datatable_clear btn btn-sm btn-default' style='display:inline'><i class='fas fa-times'></i></div>"
      );
  ...
  var filters = function () {
    ...
    extendDatatableServerParams = function () {
      ...
      var current_filter =
        attributes_for_filtering["custom_attributes"]["employers"];
      ...
      keys["custom_datatable_date_from"] = $(
        "#custom_datatable_date_from"
      ).val();
