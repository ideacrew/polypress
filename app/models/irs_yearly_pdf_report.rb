  ...
  def fill_premium_details
    ...
    (1..12).each do |index|
      ...
      if coverage_information
        ...
        if aptc_amount.present? && coverage_information.dig(:slcsp_benchmark_premium, :cents).to_f > 0
    ...
    return unless annual_aptc_amount.present? && annual_premiums.dig(:slcsp_benchmark_premium, :cents).to_f > 0
