...
module Entities
  module Templates
    ...
    class Template < Dry::Struct
      ...
      # @return [String]
      attribute :cc_recipients,           Polypress::Types::Array.of(Polypress::Types::String).optional.meta(omittable: true)
      ...
      attribute :contracts,          Polypress::Types::Array.optional.meta(omittable: true)
