...
class Template
  ...
  # this template
  # @return [String]
  attribute :sections, Sections::Section.meta(omittable: true)

  # @!attribute [r] locale
  # Template's written Language
  # @return [String]
  attribute :locale, Polypress::Types::String.optional.meta(omittable: false)
  ...
  # @return [Array<String>]
  attribute :order, Types::Array.of(Types::Symbol).meta(omittable: true)
