...
module Subscribers
  ...
  class IndividualNoticesSubscriber
    ...
    subscribe(
      ...
      logger.info "Subscribers::AccountCreatedSubscriber invoked on_enroll_individual_notices with delivery_info: #{delivery_info}, response: #{response}"
      ...
      result =
        Enrollments::GenerateAndPublishDocuments.new.call(
          { family_hash: payload, event_key: 'account_created' }
        )
