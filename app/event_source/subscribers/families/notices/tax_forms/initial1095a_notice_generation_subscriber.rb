    ...
    module Notices
      module TaxFroms
        ...
        class Initial1095aNoticeGenerationSubscriber
          ...
          include ::EventSource::Subscriber[amqp: 'edi_gateway.families.notices.tax_forms.initial1095a']
          ...
          subscribe(:on_requested) do |delivery_info, _metadata, response|
            ...
            logger.error(
              "Polypress: Initial1095aNoticeGenerationSubscriber_error: nacked due to backtrace:
